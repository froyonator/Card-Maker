...
const innerDisc = (fill: string) => ({ d: "M50 8a42 42 0 1 0 0 84a42 42 0 1 0 0-84z", fill });
/** Upper-half sheen ellipse, fakes the radial highlight on metallic energy discs. */
const sheen = (fill: string) => ({ d: "M16 40a34 24 0 1 1 68 0a34 24 0 1 1 -68 0z", fill });

export const POKEMON_SYMBOLS: SymbolDef[] = [
  { id: "energy.lightning", viewBox: "0 0 100 100", paths: [
    disc("#b07a14"),
    innerDisc("#f0b62c"),
    sheen("#f8d364"),
    // White-outlined bolt over the gold disc, like the printed energy symbol.
    { d: "M60 8 L23 60 h17 l-9 34 l46 -54 H56 Z", fill: "#ffffff" },
    { d: "M57 14 L29 56 h16 l-8 30 l36 -44 H52 Z", fill: "#f7d23d" },
  ]},
  ...
  { id: "energy.fighting",  viewBox: "0 0 100 100", paths: [
    disc("#8f5424"),
    innerDisc("#c97f44"),
    sheen("#dca169"),
    { d: "M34 30h10v18h4V26h10v22h4V30h10v34l-10 18H42L32 64z", fill: "#3d1f08" },
  ]},
  ...
  { id: "energy.colorless", viewBox: "0 0 100 100", paths: [
    disc("#b3b3b0"),
    innerDisc("#ececea"),
    sheen("#fafaf8"),
    // Gray drop shadow under a white four-point star.
    { d: "M53 19l10 24l24 10l-24 10l-10 24l-10-24l-24-10l24-10z", fill: "#9a9a96" },
    { d: "M50 16l10 24l24 10l-24 10l-10 24l-10-24l-24-10l24-10z", fill: "#ffffff" },
  ]},
];
