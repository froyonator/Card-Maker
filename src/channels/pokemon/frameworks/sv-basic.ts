...
export const svBasic: Framework = {
  ...
  layers: [
    // Chrome: full-bleed border and the card face it frames.
    ...
    // Header: stage label, name, HP, type symbol.
    ...
    // Move block: cost symbol, name, damage, body text.
    ...
    // Type bar: weakness, resistance, retreat.
    ...
    // Footer: flavor text, illustrator credit, set info, copyright line.
